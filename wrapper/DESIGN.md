...
## Einzelne Telegram-Nutzer

`ui/telegram-users.tsx` ergänzt das gemeinsame Verbindungsformular mit einzelnen
Namens-/ID-Zeilen und den bestehenden runden Iconbuttons. Die Komponente nutzt
Field-Stil, zentrale Abstände und Typografie; unter 480 px wechselt jede Person auf
zwei Zeilen. Nur der Telegram-Dialog verbirgt seinen Scrollbalken, ohne Scrollen
oder Tastaturbedienung auszuschalten. Zustände und Freigabevertrag stehen unter
[surfaces/connections.md](surfaces/connections.md#telegram-nutzerfreigabe).
