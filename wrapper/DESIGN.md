...
## Nachrichtenliste am Composer

Die Nachrichtensteuerung erweitert die vorhandene Optionszeile um „Danach“.
`MessageDeliveryList` verwendet flache, getrennte Listenzeilen über der Eingabe,
Textstatus statt rein farblicher Zustellversprechen und direkte Bearbeitung nur
für wartende Einträge. Der Vertrag unter `surfaces/chat.md` führt Zustände,
Wiederverbindung, Versionskonflikte und die ausdrückliche Fortsetzung ohne
Wiederholung unklarer Nachrichten. Gemeinsame Schrift-, Abstands-, Flächen- und
Bedienrollen gelten auch in schmalen Panels; lange Texte bleiben umbrechbar.
...
## Mail-Einrichtung und Inbox

Gmail und Outlook nutzen Original-Markenassets, den gemeinsamen Verbindungskatalog und Modal. Der normale Einstieg ist eine Anbieteranmeldung; technische Vorbereitung liegt hinter aufklappbaren Details. Helfen bedeutet Übergabe an den vorhandenen Chat mit ausgewählter Maschine. Eine neue Installation bleibt ohne Konten und ohne Nachrichtendemos. InboxConversationRow, Seitenkopf, FilterPicker und Modal werden gemeinsam eingesetzt; Aufbau und Sendefreigabe führt surfaces/inbox.md. Die Mailform ergänzt keine eigene Farb- oder Komponentenbibliothek.
