...
test('accepts semantic tokens and structural geometry',()=>{
 assert.deepEqual(rules('a.css','.a{background:conic-gradient(from 30deg,transparent,var(--text),transparent)}'),[]);
 assert.ok(rules('a.css','.a{background:conic-gradient(from 30deg,red,var(--text))}').includes('color'));
