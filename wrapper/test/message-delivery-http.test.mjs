...
test('HTTP → durable ledger → worker protocol: tools, FIFO, duplicate HTTP, completion race, socket loss and restart', {timeout:30000}, async t=>{
  ...
  await start();const id=(await post('/chats',{title:'Delivery test'})).thread.id;
