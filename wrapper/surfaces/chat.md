...
Chat und Workspace besitzen eigene Kopfbereiche. Der Workspace reicht mit 8 px Außenabstand von der oberen bis zur unteren Fensterkante und übernimmt Fläche, Rundung und Innenabstand der Seitenleiste. Beide liegen vor einem dunkleren ruhigen Hintergrund. Die Einzelansicht behält beim Öffnen und Schließen ihren schwebenden Chatkopf und dieselbe obere Verlaufskante. Mehrfachansichten behalten ihre Paneltitel unter den Chataktionen; Workspace-Köpfe erhalten keinen Tabversatz. Auf schmalen Fenstern überlagert der Workspace den Chat und bleibt über seinen eigenen Schließen-Button erreichbar. Vergrößern zeigt den Workspace über die gesamte Chatfläche; erneutes Betätigen kehrt zur automatischen Breite zurück.
...
Die Überschrift „Projekte“ und die Projektzeilen bleiben beim Scrollen fest stehen. Nur die Chatliste des aufgeklappten Projekts scrollt im verbleibenden Platz. Ihr unterer Rand blendet über 32 px weich aus; entsprechender Endabstand hält den letzten Eintrag vollständig erreichbar. Die Agentenzeile bleibt außerhalb des Scrollbereichs. Im erzwungenen Kontrastmodus entfällt der Fade.
