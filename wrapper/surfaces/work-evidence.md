...
Quellen: ui/work-evidence.tsx (ServiceSettings), ui/work-evidence.css und ui/work-evidence.mjs. Fachkonzept: ../../docs/ARBEITSNACHWEIS.md. Einstieg über ?view=service; bisheriges ?view=work-evidence öffnet denselben Einstellungsbereich. Keine echten Arbeitszeiten oder Sends. Die spätere Bedienung über eine Session bleibt ausdrücklich zur Diskussion offen. Meldungsänderungen sind nur lokaler Vorschauzustand.

Neue Kunden starten ohne eingeschaltete Beispieldaten. Die vorhandene Vorschauauswahl bleibt erhalten; echte Erfassung ist noch nicht implementiert.

Der Leerzustand nennt die echte Erfassung ausdrücklich als noch nicht implementiert,
damit fehlender Ausbau und eine fehlende Kundenanbindung unterscheidbar bleiben.
