...
export function DesignReference({ theme, tone, accent }) {
  ...
  return (
    <section className="ci-reference design-reference-page" aria-labelledby="ci-title">
      ...
      <div className="composer pill-composer"><ComposerHeading><span className="model-trigger">Modell · Denkstufe</span></ComposerHeading><div className="composer-entry"><textarea aria-label="Nachricht · Designvorschau" placeholder="Nachricht" value={suggestionDraft} rows={1} readOnly/></div></div>
