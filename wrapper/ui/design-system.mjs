...
export const identity = {
  ...
  version: "1.0",
  description:
    "Ruhig, klar und persönlich. Warme neutrale Flächen, präzise Typografie und ein zurückhaltender Orange-Akzent.",
};
export const fonts = [
  {
    name: "System-Serif",
...
export const radii = { small: 4, control: 8, button: 999, panel: 16, large: 24, pill: 999 };
