...
export const typeMetrics = { "calendar-hour-height":"64px", "calendar-month-event-height":"22px", "calendar-day-number-height":"24px", "calendar-week-gutter":"40px", "calendar-leading":"1", "font-root-size": "16px", "tracking-title": "-0.65px", "tracking-heading": "-0.35px", "tracking-welcome": "-0.7px" };
