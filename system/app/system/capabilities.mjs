...
export const capabilities = {
  ...
  domains: [
    {id:'workspaces', sources:['core/layout.py','core/config.py','core/storage.py','wrapper/layout.mjs','wrapper/storage.mjs','backend/worker-context.mjs','wrapper/agent-files.mjs','wrapper/ui/agent-files.jsx'], contract:'docs/WORKSPACES.md', status:'/api/bootstrap', backend:'Shared identity, scoped knowledge, portable workspace paths and journaled migration'},
