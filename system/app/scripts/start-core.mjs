...
const previous=path.join(installationRoot,'.venv',process.platform==='win32'?'Scripts/python.exe':'bin/python');
const python=process.env.AGENT_PYTHON || (existsSync(local)?local:existsSync(previous)?previous:'python3');
