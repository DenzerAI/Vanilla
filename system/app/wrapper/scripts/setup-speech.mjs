...
import {installationRoot,layoutManifest} from '../layout.mjs';
...
const root=path.resolve(process.env.UWE_DATA_ROOT || path.join(installationRoot,layoutManifest(installationRoot)?.data || 'system/data/control'));
