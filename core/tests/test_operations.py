...
def test_mcp_routes_share_versions_and_enforce_projects(config):
    ...
    with TestClient(create_app(config)) as client:
        ...
        assert {t['name'] for t in listing['result']['tools']}=={'memory_read','memory_write','memory_search','memory_context','inbox_setup','inbox_accounts','inbox_threads','inbox_read','inbox_draft','inbox_compose','inbox_send'}
