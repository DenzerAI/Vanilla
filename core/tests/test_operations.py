...
def test_mcp_routes_share_versions_and_enforce_projects(config):
    ...
    with TestClient(create_app(config)) as client:
        ...
        assert {t['name'] for t in listing['result']['tools']}=={'memory_read','memory_write','memory_search','memory_context','routine_capabilities','routine_list','routine_create','routine_update'}
